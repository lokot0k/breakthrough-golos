    ...
    return <div className="Test">
        ...
        <div className="body">
            ...
            <div className="qr-code-section">
                <FormControlLabel value={censure} onChange={async (event, checked) => {setCensure(checked); await makeRequest()}} control={<Switch/>}
                                  label={"Цензура"} />
                <FormControlLabel value={fast} onChange={async (event, checked) => {setFast(checked); await makeRequest()}} control={<Switch/>}
